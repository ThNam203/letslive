...
func (r *postgresVODRepo) SetAuthorDisabled(ctx context.Context, userId uuid.UUID, disabled bool) error {
...
func (r *postgresVODRepo) ReplaceDisabledAuthors(ctx context.Context, userIds []uuid.UUID) error {
	if userIds == nil {
		userIds = []uuid.UUID{}
	}
