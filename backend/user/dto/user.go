...
type GetUserResponseDTO struct {
	...
	LiveStatus        domains.UserLiveStatus `json:"liveStatus"`
	...
	VODs                          []GetLivestreamResponseDTO `json:"vods,omitempty"`
}
...
type UpdateUserRequestDTO struct {
	...
	LiveStatus  *domains.UserLiveStatus `json:"liveStatus,omitempty" validate:"oneof=off on"`
