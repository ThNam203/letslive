...
func (s *PurchaseService) Purchase(ctx context.Context, actorID uuid.UUID, req dto.PurchaseRequestDTO) (*dto.PurchaseResponseDTO, error) {
	...
	if available < totalCost {
		return nil, domains.ErrInsufficientBalance
	}
	...
	if req.RecipientUserId != nil {
		...
		if err != nil {
			...
			return nil, domains.ErrUserService
		}
