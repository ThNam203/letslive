...
const (
	RES_ERR_INVALID_INPUT_KEY                = "res_err_invalid_input_key"
	RES_ERR_INVALID_PAYLOAD_KEY              = "res_err_invalid_payload_key"
	RES_ERR_AUTH_ALREADY_EXISTS_KEY          = "res_err_auth_already_exists_key"
	RES_ERR_CAPTCHA_FAILED_KEY               = "res_err_captcha_failed_key"
	RES_ERR_PASSWORD_NOT_MATCH_KEY           = "res_err_password_not_match_key"
	RES_ERR_UNAUTHORIZED_KEY                 = "res_err_unauthorized_key"
	RES_ERR_SIGN_UP_OTP_EXPIRED_KEY          = "res_err_sign_up_otp_expired_key"
	RES_ERR_EMAIL_OR_PASSWORD_INCORRECT_KEY  = "res_err_email_or_password_incorrect_key"
	RES_ERR_FORBIDDEN_KEY                    = "res_err_forbidden_key"
	RES_ERR_AUTH_NOT_FOUND_KEY               = "res_err_auth_not_found_key"
	RES_ERR_REFRESH_TOKEN_NOT_FOUND_KEY      = "res_err_refresh_token_not_found_key"
	RES_ERR_SIGN_UP_OTP_NOT_FOUND_KEY        = "res_err_sign_up_otp_not_found_key"
	RES_ERR_ROUTE_NOT_FOUND_KEY              = "res_err_route_not_found_key"
	RES_ERR_SIGN_UP_OTP_ALREADY_USED_KEY     = "res_err_sign_up_otp_already_used_key"
	RES_ERR_FAILED_TO_CREATE_SIGN_UP_OTP_KEY = "res_err_failed_to_create_sign_up_otp_key"
	RES_ERR_DATABASE_QUERY_KEY               = "res_err_database_query_key"
	RES_ERR_DATABASE_ISSUE_KEY               = "res_err_database_issue_key"
	RES_ERR_INTERNAL_SERVER_KEY              = "res_err_internal_server_key"
	RES_ERR_FAILED_TO_SEND_VERIFICATION_KEY  = "res_err_failed_to_send_verification_key"
)
