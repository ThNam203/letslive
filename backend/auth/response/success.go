...
const (
	RES_SUCC_SENT_VERIFICATION_CODE = 10000
	RES_SUCC_EMAIL_VERIFIED_CODE    = 10001
)

const (
	RES_SUCC_SENT_VERIFICATION_KEY = "res_succ_sent_verification_key"
	RES_SUCC_EMAIL_VERIFIED_KEY    = "res_succ_email_verified_key"
)
...
var (
	RES_SUCC_SENT_VERIFICATION = ResponseTemplate{
		Success:    true,
		StatusCode: 201,
		Code:       RES_SUCC_SENT_VERIFICATION_CODE,
		Key:        RES_SUCC_SENT_VERIFICATION_KEY,
