function getBackendUrl(): string {
    ...
    if (!protocol || !ipAddress || !port || protocol === "" || ipAddress === "" || port === "") {
        if (typeof window !== "undefined") {
            console.error(
                "Missing or empty backend environment variables:",
                {
...
function getWebSocketUrl(): string {
    ...
    if (!wsProtocol || !ipAddress || !port || wsProtocol === "" || ipAddress === "" || port === "") {
        if (typeof window !== "undefined") {
            console.error(
                "Missing or empty WebSocket environment variables:",
                {
