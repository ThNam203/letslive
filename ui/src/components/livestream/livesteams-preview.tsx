...
const StreamsSeparator = ({ onClick }: { onClick: () => void }) => {
    ...
    return (
        <div className="flex w-full flex-row items-center justify-between gap-4">
            ...
            <button
                className="border-border text-primary hover:text-primary-hover flex flex-row items-center justify-center text-nowrap rounded-md px-2 py-1 text-xs font-semibold duration-100 ease-linear"
                onClick={onClick}
            >
